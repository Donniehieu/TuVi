...
function LuanCachCucSaoLiemTrinhQuanLoc(keyArr) {
    ...
    if (isHaiSaoDongCungTaiCung("Quan Lộc", "Liêm Trinh", "Thiên Phủ")) {
        ...
        if (isSaoToaThuTaiCung("Quan Lộc", "Hóa Kỵ")) {
            if (isSaoToaThuTaiCungVaChi("Quan Lộc", "Thìn", "Thiên Phủ")) {
                keyArr.push("Liêm Trinh, Thiên Phủ, Hóa Kỵ đồng cung tại Quan Lộc ở Thìn");

            }
            if (isSaoToaThuTaiCungVaChi("Quan Lộc", "Tuất", "Thiên Phủ")) {
                keyArr.push("Liêm Trinh, Thiên Phủ, Hóa Kỵ đồng cung tại Quan Lộc ở Tuất");
            }
    ...
    if (isHaiSaoDongCungTaiCung("Quan Lộc", "Liêm Trinh", "Hóa Kỵ")) {
        ...
        if (isSaoToaThuTaiCungVaChi("Quan Lộc", "Thân", "Hóa Kỵ")) {
            keyArr.push("Liêm Trinh, Hóa Kỵ đồng cung tại Quan Lộc ở Thân");
        }
        if (isSaoToaThuTaiCungVaChi("Quan Lộc", "Dần", "Hóa Kỵ")) {
            keyArr.push("Liêm Trinh, Hóa Kỵ đồng cung tại Quan Lộc ở Dần");
        }



    }
    if (isHaiSaoDongCungTaiCung("Quan Lộc", "Hóa Kỵ", "Thái Âm")) {
        if (isHaiSaoDongCungTaiCung("Quan Lộc", "Kình Dương", "Thái Âm")) {
            keyArr.push("Hóa Kỵ, Thái Âm, Kình Dương đồng cung tại Quan Lộc");
        }
        if (isHaiSaoDongCungTaiCung("Quan Lộc", "Thái Âm", "Địa Không")) {
            keyArr.push("Hóa Kỵ, Thái Âm, Địa Không đồng cung tại Quan Lộc");
        }
        if (isHaiSaoDongCungTaiCung("Quan Lộc", "Địa Không", "Địa Kiếp")) {
            keyArr.push("Hóa Kỵ, Thái Âm, Đia Không, Địa Kiếp đồng cung tại Quan Lộc");
        }
